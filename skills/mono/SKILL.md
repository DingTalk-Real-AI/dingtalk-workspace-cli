...
| `devapp`          | 开放平台应用：企业内部应用查询/详情/创建/修改/删除、成员管理、安全配置、应用权限 APP/SNS 列表与申请取消、凭证读取、机器人创建与配置、版本创建/发布/审批       | [devapp.md](./references/products/devapp.md)                   |
...
- "应用" 是泛词，不默认等于开放平台应用。只有出现"开放平台应用/开发者后台应用/企业内部应用"，
  或伴随 `agentId/clientId/appKey/appSecret/customKey/应用成员/安全配置/IP 白名单/登录重定向/应用权限/权限点/创建机器人/智能体机器人/机器人配置/事件订阅/应用版本/发布审核`
...
用户提到"开放平台应用/开发者后台应用/企业内部应用/应用 agentId/clientId/appKey/appSecret/应用成员/安全配置/IP 白名单/登录重定向/应用权限/权限点/创建机器人/智能体机器人/机器人配置/事件订阅/应用版本发布/审核" → `devapp`

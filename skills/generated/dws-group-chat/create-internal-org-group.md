---
name: dws-group-chat-create-internal-org-group
...
metadata:
  ...
  openclaw:
    ...
    requires:
      bins:
        - dws
    cliHelp: "dws chat create_internal_org_group --help"
---

# group-chat create_internal_org_group
...
```bash
dws chat create_internal_org_group --json '{...}'
```
...
|------|----------|---------|-------------|
| `--groupMembers` | ✓ | — | 初始化添加的群聊成员。需要使用钉钉userId |
| `--groupName` | ✓ | — | 群名称 |

...
- Prompt: 监听我和 userId 507971 的单聊消息，并对方发什么自动回复什么
- Expected: `dws event consume user_im_message_receive_o2o --user 507971 -f ndjson`
- Flags: `--user` = `507971`
...
- Prompt: 监听我发给 userId 507971 的单聊消息是否已读
- Expected: `dws event consume user_im_message_read_o2o --user 507971 -f ndjson`
- Flags: `--user` = `507971`
...
- Prompt: 监听我和 userId 507971 的单聊消息撤回事件
- Expected: `dws event consume user_im_message_recall_o2o --user 507971 -f ndjson`
- Flags: `--user` = `507971`
...
**event_event_consume_emotion_o2o_001**
- Prompt: 监听我和 userId 507971 的单聊消息贴表情事件
- Expected: `dws event consume user_im_message_emotion_o2o --user 507971 -f ndjson`
- Flags: `--user` = `507971`

#### `dws event consume user_im_message_emotion_group`

**event_event_consume_emotion_group_001**
- Prompt: 监听 openConversationId cid123 的群消息表情回应事件
- Expected: `dws event consume user_im_message_emotion_group --group cid123 -f ndjson`
- Flags: `--group` = `cid123`

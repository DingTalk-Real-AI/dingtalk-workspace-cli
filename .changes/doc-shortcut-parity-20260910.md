...
- **Doc download confirmation** — media download, media preview, and cover download require confirmation before local writes, including explicit overwrite; preserve the preview output shorthand `-o`.

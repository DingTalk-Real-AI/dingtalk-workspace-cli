...
require_test internal/corecmd TestCrossPlatformCoverageLazyCobraValidation
require_test internal/corecmd TestCrossPlatformCoverageNativeValidationAdapter
...
require_test internal/app TestCrossPlatformCoverageLazyValidationCleansInvocationFlags

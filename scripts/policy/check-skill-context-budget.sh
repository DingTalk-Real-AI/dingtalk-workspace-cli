...
if grep -Fq "../dws-shared/SKILL.md" "$doc_skill"; then
	printf '%s\n' \
		"skill context regression: $doc_skill requires full dws-shared cold-start loading" >&2
	exit 1
fi

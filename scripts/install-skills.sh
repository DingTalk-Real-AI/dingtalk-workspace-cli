...
# Exact upstream registry (77 IDs): id|classification|effective-global-root.
...
resolve_agent_skill_base() {
  ...
  case "$_ras_agent" in
    ...
    ".dsh/skills") printf '%s\n' "${DSH_HOME:-$HOME/.dsh}/skills"; return ;;
  esac

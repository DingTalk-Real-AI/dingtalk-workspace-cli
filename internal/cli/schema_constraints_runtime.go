...
func init() {
	...
	registerRequireOneOf("chat.add_emoji_reaction", "conversation-id")
	registerRequireOneOf("chat.add_text_emotion", "conversation-id")
	registerRequireOneOf("chat.update_text_emotion", "conversation-id")
	registerExclusiveOneOf("chat.get_conversation_info", "conversation-id", "user-id", "open-dingtalk-id")
	registerExclusiveOneOf("chat.list_conversation_message_v2", "conversation-id", "user-id", "open-dingtalk-id")
	registerExclusiveOneOf("chat.list_individual_chat_message", "user-id", "open-dingtalk-id")
	registerRequireOneOf("chat.remove_emoji_reaction", "conversation-id")
	registerRequireOneOf("chat.remove_text_emotion", "conversation-id")
	...
	registerRequireOneOf("chat.set_group_member_mute_list", "users", "user-id")
	registerExclusiveOneOf("chat.transfer_group_owner", "new-owner", "user-id")
	registerRequireOneOf("chat.update_conv_member_roles", "users", "user-id")
	registerRequireOneOf("chat.update_notification_off", "conversation-id")

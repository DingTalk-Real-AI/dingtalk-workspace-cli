...
func init() {
	...
	registerExclusiveOneOf("chat.create_and_send_card", "group", "conversation-id", "receiver")
	registerExclusiveOneOf("chat.get_conversation_info", "group", "conversation-id", "user", "user-id", "open-dingtalk-id")
	registerExclusiveOneOf("chat.list_conversation_message_v2", "group", "conversation-id", "user", "user-id", "open-dingtalk-id")
	registerExclusiveOneOf("chat.list_individual_chat_message", "user", "user-id", "open-dingtalk-id")
	...
	registerExclusiveOneOf("chat.send_robot_message", "group", "conversation-id", "users")
	registerRequireOneOf("chat.set_group_member_mute_list", "users", "user", "user-id")
	registerExclusiveOneOf("chat.transfer_group_owner", "new-owner", "user", "user-id")
	registerRequireOneOf("chat.update_conv_member_roles", "users", "user", "user-id")

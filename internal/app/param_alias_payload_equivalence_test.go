...
var paramAliasCompleteCommands = map[string][]string{
	...
	"chat category rename":                     {"chat", "category", "rename", "--category-id", "7", "--title", "Renamed Cat", "--yes"},
	"chat group members":                       {"chat", "group", "members", "--conversation-id", "fixture-conversation"},
	"chat group members add":                   {"chat", "group", "members", "add", "--conversation-id", "fixture-conversation", "--users", "D-user-1"},
	"chat group members add-bot":               {"chat", "group", "members", "add-bot", "--conversation-id", "fixture-conversation", "--robot-code", "robot-1", "--yes"},
	"chat group members list-by-ids":           {"chat", "group", "members", "list-by-ids", "--conversation-id", "fixture-conversation", "--users", "D-user-1,D-user-2"},
	"chat group members remove":                {"chat", "group", "members", "remove", "--conversation-id", "fixture-conversation", "--users", "D-user-1", "--yes"},
	"chat group members remove-bot":            {"chat", "group", "members", "remove-bot", "--conversation-id", "fixture-conversation", "--bot-id", "bot-1", "--yes"},
	"chat group rename":                        {"chat", "group", "rename", "--conversation-id", "fixture-conversation", "--name", "Fixture Renamed Group", "--yes"},
	...
	"chat message add-favorite":                {"chat", "message", "add-favorite", "--message-id", "message-1", "--conversation-id", "fixture-conversation", "--yes"},

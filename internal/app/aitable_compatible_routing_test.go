...
func TestCrossPlatformCoverageAitableCapabilityRouteSelection(t *testing.T) {
	for _, tc := range []struct {
		...
		t.Run(tc.name, func(t *testing.T) {
			var checked []string
			testseam.Swap(t, &runnerListProductTools, func(_ *runtimeRunner, _ context.Context, product, tool string) ([]transport.ToolDescriptor, error) {
...
func TestCrossPlatformCoverageAitableCapabilityRouteFailsClosed(t *testing.T) {
	...
	testseam.Swap(t, &runnerListProductTools, func(_ *runtimeRunner, _ context.Context, _, _ string) ([]transport.ToolDescriptor, error) {
		return nil, wantErr
	})

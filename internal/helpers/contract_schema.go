...
func declareContractSchema(r *contractSchemaRefs) {
	...
	// ── review（Schema 仅作弃用迁移说明；不得宣称可完成已退役审查业务）──
	DeclareLeafMetadata(r.ReviewBenefit, LeafSpec{
		...
		Contract: LeafContract{
			...
			Selection: contract.SelectionSpec{
				...
				AvoidWhen: []string{
					"用户要查看合同审查权益额度或使用情况——旧 MCP 已退役，本工具无法完成",
					"用户要对合同发起 AI 审查、解析合同或查询审查结果——不要选择本工具",
				},
	...
	DeclareLeafMetadata(r.ReviewCreate, LeafSpec{
		...
		Contract: LeafContract{
			...
			Selection: contract.SelectionSpec{
				...
				AvoidWhen: []string{
					"用户要对合同文件发起 AI 审查——旧 MCP 已退役，本工具无法完成",
					"用户要解析合同或查询审查结果——不要选择本工具",
				},
	...
	DeclareLeafMetadata(r.ReviewAnalysis, LeafSpec{
		...
		Contract: LeafContract{
			...
			Selection: contract.SelectionSpec{
				...
				AvoidWhen: []string{
					"用户要解析合同文件获取摘要和审查建议——旧 MCP 已退役，本工具无法完成",
					"用户要创建审查任务或查询审查结果——不要选择本工具",
				},
	...
	DeclareLeafMetadata(r.ReviewResult, LeafSpec{
		...
		Contract: LeafContract{
			...
			Selection: contract.SelectionSpec{
				...
				AvoidWhen: []string{
					"用户已创建审查任务后要查询审查结果——旧 MCP 已退役，本工具无法完成",
					"用户要创建审查任务——不要选择本工具",
				},

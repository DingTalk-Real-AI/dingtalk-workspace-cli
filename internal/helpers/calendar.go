...
命令结构:
  dws calendar event       [list|list-mine|get|create|update|delete|suggest|respond]  日程管理
  ...
  dws calendar event list --format json`,
	...
	eventListPersonalCmd := &cobra.Command{
		Use:   "list-mine",
		Short: "查询归属个人的日程列表",
		Long:  `查询结果只包含 创建时选择归属组织为 “个人” 的日程。完整数据请使用 list 指令。**注意** 不传 --start/--end 时将查询今天的日程（00:00:00 ~ 23:59:59）。`,
		Example: `  dws calendar event list-mine
  dws calendar event list-mine --start "2026-03-10T14:00:00+08:00" --end "2026-03-10T18:00:00+08:00"
  dws calendar event list-mine --limit 20
  dws calendar event list-mine --cursor "<nextCursor从上一次查询结果获取>"`,
		RunE: func(cmd *cobra.Command, args []string) error {
			toolArgs := map[string]any{}
			...
			if v := flagOrFallback(cmd, "start", "time-min", "min-time", "start-time", "startTime", "start_time", "start-date", "startDate"); v != "" {
				var err error
				startMs, err = parseISOTimeToMillis("start", v)
				if err != nil {
					return err
				}
				toolArgs["startTime"] = startMs
			} else {
				now = time.Now()
				startMs = time.Date(now.Year(), now.Month(), now.Day(), 0, 0, 0, 0, now.Location()).UnixMilli()
				toolArgs["startTime"] = startMs
			}
			if v := flagOrFallback(cmd, "end", "time-max", "max-time", "end-time", "endTime", "end_time", "end-date", "endDate"); v != "" {
				var err error
			...
			return callSortedCalendarEvents(cmd, "list_personal_calendar_events", toolArgs)
		},
	}
...
至少包含 --recurrence-type、--recurrence-interval(>0) 与 --recurrence-range-type，否则命令会被拒绝执行。`,
  ...
  dws calendar book update --id CALENDAR_ID --desc "日历描述"`,
	...
	// ListMine flags
	eventListPersonalCmd.Flags().String("start", "", "开始时间 ISO-8601 (例如 2026-03-10T14:00:00+08:00)")
	eventListPersonalCmd.Flags().String("end", "", "结束时间 ISO-8601 (例如 2026-03-10T18:00:00+08:00)")
	eventListPersonalCmd.Flags().String("time-min", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("time-min")
	eventListPersonalCmd.Flags().String("time-max", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("time-max")
	eventListPersonalCmd.Flags().String("min-time", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("min-time")
	eventListPersonalCmd.Flags().String("max-time", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("max-time")
	eventListPersonalCmd.Flags().String("start-time", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("start-time")
	eventListPersonalCmd.Flags().String("end-time", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("end-time")
	eventListPersonalCmd.Flags().String("startTime", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("startTime")
	eventListPersonalCmd.Flags().String("endTime", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("endTime")
	eventListPersonalCmd.Flags().String("start_time", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("start_time")
	eventListPersonalCmd.Flags().String("end_time", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("end_time")
	eventListPersonalCmd.Flags().String("start-date", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("start-date")
	eventListPersonalCmd.Flags().String("end-date", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("end-date")
	eventListPersonalCmd.Flags().String("startDate", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("startDate")
	eventListPersonalCmd.Flags().String("endDate", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("endDate")

	eventListPersonalCmd.Flags().String("cursor", "", "分页游标 (首次查询无需传入，仅翻页时传入上一次返回的 nextCursor)")
	eventListPersonalCmd.Flags().String("next-cursor", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("next-cursor")
	eventListPersonalCmd.Flags().String("nextCursor", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("nextCursor")
	eventListPersonalCmd.Flags().String("page-token", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("page-token")
	eventListPersonalCmd.Flags().String("pageToken", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("pageToken")
	eventListPersonalCmd.Flags().String("next-token", "", "")
	_ = eventListPersonalCmd.Flags().MarkHidden("next-token")
	...
	eventListPersonalCmd.Flags().Int("limit", 0, "每页返回条数 (默认 100，最大 100)")
	eventListPersonalCmd.Flags().Int("max-results", 0, "")
	_ = eventListPersonalCmd.Flags().MarkHidden("max-results")
	eventListPersonalCmd.Flags().Int("maxResults", 0, "")
	_ = eventListPersonalCmd.Flags().MarkHidden("maxResults")
	eventListPersonalCmd.Flags().Int("page-size", 0, "")
	_ = eventListPersonalCmd.Flags().MarkHidden("page-size")
	eventListPersonalCmd.Flags().Int("size", 0, "")
	_ = eventListPersonalCmd.Flags().MarkHidden("size")
	eventListPersonalCmd.Flags().Int("count", 0, "")
	_ = eventListPersonalCmd.Flags().MarkHidden("count")
	...
	eventCmd.AddCommand(eventListCmd, eventListPersonalCmd, eventGetCmd, eventCreateCmd, eventUpdateCmd, eventDeleteCmd, eventSuggestCmd, eventRespondCmd)
	...
	root.AddCommand(
		...
		calendarInfoHintSubCmd("list-mine", "did you mean: 'dws calendar event list-mine'"),
...
func callSortedCalendarEvents(cmd *cobra.Command, toolName string, toolArgs map[string]any) error {
	...
	// `event list` / `event list-mine` default to today's 00:00:00~23:59:59
	// when --start/--end are omitted, which is easy for callers to miss.
...
func attachCalendarSearchRange(parsed map[string]any, cmd *cobra.Command, toolArgs map[string]any) {
	...
	if cmd != nil && cmd.Name() == "list-mine" {
		hint += " 注意：查询结果只包含 创建时选择归属组织为 “个人” 的日程。完整数据请使用 list 指令。"
	}

...
var CommentList = shortcut.Shortcut{
	...
	Flags: []shortcut.Flag{
		...
		{Name: "limit", Type: shortcut.FlagInt, Desc: "每页数量 (默认 50，最大 50)", Aliases: []string{"page-size"}, AliasesVisible: true},
...
var CommentCreate = shortcut.Shortcut{
	...
	Flags: []shortcut.Flag{
		...
		{Name: "selection", Type: shortcut.FlagString, Desc: "完整文字或 前缀...后缀；必须在正文中唯一匹配"},
		{Name: "block-id", Type: shortcut.FlagString, Desc: "高级通道 block ID；须与 start/end 一起提供"},
		{Name: "start", Type: shortcut.FlagInt, Desc: "块内 UTF-16 起始偏移；须与 block-id/end 一起提供"},
		{Name: "end", Type: shortcut.FlagInt, Desc: "块内 UTF-16 结束偏移；须与 block-id/start 一起提供"},
	...
	Constraints: []shortcut.Constraint{{Kind: shortcut.ConstraintCustom, Flags: []string{"selection", "block-id", "start", "end"}, Description: "selection 与高级通道互斥；block-id/start/end 必须一起提供，selection 必须唯一匹配"}},

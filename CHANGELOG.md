...
- **Windows portable-auth export contract** — `dws auth export` now fails early with a validation error instead of claiming portable-bundle support for credentials stored in DPAPI-protected HKCU Registry values.

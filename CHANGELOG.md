...
Validated against the open-source regression suite — `dws-wukong/auto-test/cli_to_mcp` with `--edition open --skip-open-unimplemented-param-cases`, account `wukong01`, on this main: **chat 107 passed / 0 failed / 0 errored / 32 skipped → 100.0% ✅ PASS** (report: `auto-test/cli_to_mcp/open_report/test_report_20260519_155449.md`).
